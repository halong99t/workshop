...
async function main() {
  ...
  const Dogebitrum = await ethers.getContractFactory("Dogebitrum");
  const DOGEBI = await Dogebitrum.deploy();
  console.log("Floppy address: ", DOGEBI.address);
  Config.setConfig(network + ".Floppy", DOGEBI.address);
  ...
  //     "0x65f00a282A58B30f8376D41832d76CeCB7b6186C"
  //   );
